...
export default function RegisterFarmer() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await registrationService.registerFarmer(payload);
      const { did } = res.data;
      
      try {
        await authService.login(did, formData.password, 'FARMER');
      ...
      if (err.code === 'ERR_NETWORK' || err.message === 'Network Error' || !err.response) {
        errorMessage = 'Network Error: Unable to connect to the server. Please ensure the backend server is running on http://localhost:3001';
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-xl p-10 text-center">
            <div className="mb-8">
              <div className="relative inline-block mb-6">
                <div className="absolute inset-0 bg-emerald-400 rounded-full blur-2xl opacity-30"></div>
                <div className="relative w-20 h-20 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto shadow-lg">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-emerald-200 rounded-xl p-6 mb-6">
                ...
                <p className="font-mono text-base font-bold text-emerald-700 break-all bg-white/50 px-4 py-3 rounded-lg border border-emerald-200">{success.did}</p>
              </div>
            </div>
            <button
              onClick={handleGoToDashboard}
              className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white py-4 rounded-xl hover:from-emerald-700 hover:to-teal-700 font-bold text-base shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02]"
            >
              Go to Dashboard
            </button>
          </div>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">Farmer Registration</h1>
              <p className="text-gray-600 mt-1.5">Join UNI-CHAIN to track and manage your agricultural produce</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, idValue: e.target.value.replace(/[^0-9]/g, '') })
                  }
